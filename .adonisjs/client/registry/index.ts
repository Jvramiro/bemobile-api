...
const routes = {
  ...
  'gateways.set_active': {
    ...
    tokens: [{"old":"/gateways/:id/active","type":0,"val":"gateways","end":""},{"old":"/gateways/:id/active","type":1,"val":"id","end":""},{"old":"/gateways/:id/active","type":0,"val":"active","end":""}],
    types: placeholder as Registry['gateways.set_active']['types'],
  },
